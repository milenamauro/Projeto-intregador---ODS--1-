package com.edg.Backendedg.configuration;
...
public class SwaggerConfig {
	...
	.basePackage("com.EDG.BackEndEDG.controller"))
	...
	public static ApiInfo metadata() {
		...
		.title("API - É de Graça!")
		.description("Projeto Integrador Generation Brasil - Grupo 1 - API É de Graça!")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/milenamauro")
		.contact(contact())
		.build();
		}
	
	private static Contact contact() {
		return new Contact("Milena Mauro",
		"https://github.com/milenamauro",
		"milena.93@hotmail.com");
		}
